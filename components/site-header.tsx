          ...
          <div className="flex shrink-0 items-center gap-2">
            {!mounted || status === "loading" ? (
              ...
              <>
                <Link
                  href="/dashboard"
                  className="hidden items-center gap-2 rounded-full border border-gray-200 bg-gray-50 px-4 py-2 text-sm text-slate-900 transition-all hover:border-orange-200 hover:bg-orange-50 active:scale-95 sm:flex"
                >
